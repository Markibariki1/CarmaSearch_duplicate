    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                {isGain ? <TrendingUp className="h-4 w-4 text-gain" /> : <TrendingDown className="h-4 w-4 text-loss" />}
                <p className={`text-2xl font-bold ${isGain ? "text-gain" : "text-loss"}`}>
                  ${Math.abs(gainLoss).toLocaleString()}
                </p>
                <span className={`text-sm ${isGain ? "text-gain" : "text-loss"}`}>
                  ({isGain ? "+" : "-"}
                  {gainLossPercentage}%)
                </span>
              </div>
              ...
              <LineChart data={currentPerformanceData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                ...
                <Tooltip
                  ...
                  formatter={(value: number, name, props) => {
                    ...
                    const changeColor = change >= 0 ? "hsl(var(--gain))" : "hsl(var(--loss))"
                    return [
                      <div key="tooltip">
                ...
                <Line
                  ...
                  dot={(props: any) => {
                    ...
                    const color = change >= 0 ? "hsl(var(--gain))" : change < 0 ? "hsl(var(--loss))" : "#FFFFFF"
                    return <circle key={key} cx={cx} cy={cy} fill={color} stroke="#FFFFFF" strokeWidth={3} r={6} />
                  }}
                />
              </LineChart>
            </ResponsiveContainer>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card className="border-border/50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-automotive-neutral/10 rounded-lg">
                <TrendingUp className="h-5 w-5 text-automotive-neutral" />
              </div>
              <div>
        ...
        <Card className="border-border/50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-automotive-premium/10 rounded-lg">
                <TrendingUp className="h-5 w-5 text-automotive-premium" />
              </div>
              <div>
